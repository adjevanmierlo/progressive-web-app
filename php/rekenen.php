...
<head>
    ...
    <title>sommetjes</title>
</head>
<body>
<div id="snow"></div>
    <?php

    $sql= "SELECT * FROM spel1 ORDER BY rand() limit 1";  //select alles van db spel random limit is niet meer dan 1
    ...
    {   
        ...
        $htmlOutput .= '<img src="../img/rek/' . $row['afbeelding'] . '" class="afbeelding">';  // hier zeg ik dat hij moet gaan zoeken in het mapje img 
