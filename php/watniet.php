...
<div id="snow"></div>
    ...
    $sql= "SELECT * FROM spel2 ORDER BY rand() limit 1";  //select alles van db spel random limit is niet meer dan 1
    ...
    {   
        ...
        $htmlOutput .= '<img src="../img/wat hoort er niet bij/' . $row['afbeelding'] . '" class="afbeelding">';  // hier zeg ik dat hij moet gaan zoeken in het mapje img 
